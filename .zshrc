...
alias hr="herdr"
alias hrs="herdr status server"
alias hrc="herdr config check"
alias hrr="herdr server reload-config"
alias hrsl="herdr session list"
alias hrw="herdr workspace list"
alias hrt="herdr tab list"
alias hrp="herdr pane list"
alias hra="herdr agent list"
alias hri="herdr integration status"
